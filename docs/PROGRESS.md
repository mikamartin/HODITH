...
- [ ] **Phase 4** — Settings foundation: DataStore-backed theme/voice picker (unblocks exercising Phase 5's themes) + promoting demo-data seeding from a debug-only mechanism to a real "load demo data" / "delete all data" pair of actions in Settings.
