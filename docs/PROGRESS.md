...
- [ ] **Phase 10** — Share cards, export/import, Settings polish (About).
  - **Branches, in dependency order:**
    ...
    2. [ ] `feature/about-screen` — wiring only: About screen reached from Settings, real navigation, placeholder copy for version/privacy statement/licenses (spec §14, §16). Actual content (final copy, hosted privacy policy link) is a Phase 12 follow-up, not this branch.
