...
| Compose UI — About | Version/privacy/licenses sections render their Voice-provided copy; back button invokes the callback; Settings' About row navigates there |
