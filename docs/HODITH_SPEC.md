...
| **Edit event** | §6 — full-screen editor for an existing event (`TopAppBar` back arrow + delete action, mirroring New/edit Case). Reached from Case Detail's Log tab (row tap, or the stale-ongoing "edit end time" prompt). |
