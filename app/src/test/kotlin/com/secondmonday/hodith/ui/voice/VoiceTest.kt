...
class VoiceTest {
    ...
    fun `every voice has a non-blank string for every key`() {
        for (voice in voices) {
            ...
            assertTrue(voice.settingsCloudBackupToggleLabel.isNotBlank())
            assertTrue(voice.settingsCloudBackupInfoTitle.isNotBlank())
            assertTrue(voice.settingsCloudBackupInfoBody.isNotBlank())
            ...
            assertTrue(voice.aboutIdeaLabel.isNotBlank())
            assertTrue(voice.aboutIdeaBody.isNotBlank())
            assertTrue(voice.aboutVersionLabel.isNotBlank())
            assertTrue(voice.aboutDeveloperModeUnlockedMessage.isNotBlank())
            assertTrue(voice.aboutPrivacyLabel.isNotBlank())
            assertTrue(voice.aboutPrivacyBody.isNotBlank())
            assertTrue(voice.aboutPrivacyPolicyLinkLabel.isNotBlank())
            assertTrue(voice.aboutLicensesLabel.isNotBlank())
            assertTrue(voice.aboutLicensesBody.isNotBlank())
