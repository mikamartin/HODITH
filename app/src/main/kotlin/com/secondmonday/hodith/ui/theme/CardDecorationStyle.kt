...
/**
 * Which structural treatment shared list/card composables use (spec §12) — Plain and Intense
 * keep today's plain [androidx.compose.material3.Card]/row chrome, Bright picks up the
 * gradient-wash [GlowCard]/[IconHalo] treatment. Picked centrally here, like
 * [hodithColorScheme]/[hodithTypography]/[hodithShapes]
